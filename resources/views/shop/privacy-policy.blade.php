...
<article class="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
    <div class="prose prose-slate max-w-none text-stone-700 leading-relaxed space-y-6">
        ...
        <section>
            ...
            <p>Questions, requests, or complaints about this policy? Reach out at <a href="mailto:info@elephantspices.com" class="text-brand">info@elephantspices.com</a> or <a href="tel:9915954385" class="text-brand">+91 9915954385</a>.</p>
        </section>
